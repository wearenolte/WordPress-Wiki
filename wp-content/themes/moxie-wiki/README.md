...
Moxie Wiki is a Minimal Starter theme that is Responsive out of the box. It uses Sass along with Bourbon Neat for help with Responsive grids. It's based on _s and is pretty rad.


Donate (or submit a pull request)
---------------
<a href='https://pledgie.com/campaigns/27978'><img alt='Click here to lend your support to: Moxie Wiki, a WordPress Starter Theme and make a donation at pledgie.com !' src='https://pledgie.com/campaigns/27978.png?skin_name=chrome' border='0' ></a>
...
* #### Install Gulpjs, Composer and Bower + Dependencies
  ...
  * **Install Bower Dependencies** - There are Sass and Js packages that are required by Moxie Wiki. To get them run this command: `bower install` - This will install the theme's dependencies such as bourbon, neat, flexnav etc.
 ...
 * #### Generating your styles
   * In pre 1.1.11 builds of Moxie Wiki, Style.scss would process/compile all of your changes to the various Sass files. This has changed in 1.1.11. We have added rtl
...
* #### Gulp Tasks
There are a couple of tasks built into Moxie Wiki to help get you going.
...
I'm gonna recommend you [have a look at this issue here] (wiki.getmoxied.net/issues/58) for details on how to go about this.
